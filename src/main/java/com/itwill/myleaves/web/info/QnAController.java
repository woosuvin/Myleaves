...
public class QnAController {
	...
	@GetMapping
	public String readQnA(Model model , @PageableDefault(page=0, size=10, sort="qid", direction=Sort.Direction.DESC) Pageable pageable) {
		log.info("QNA read()");
	...
	@PreAuthorize("hasRole('MEMBER')")
	@GetMapping("/search")
	public String searchQnA(QnASearchAndPageDto dto, Model model, @PageableDefault(page=0, size=10, sort="qid", direction=Sort.Direction.DESC) Pageable pageable) {
